...
Function PageReinstall
  ...
  ; Upgrading: overlay into the existing folder, do not ask to uninstall first.
  ${ElseIf} $R0 = 1
    StrCpy $UpdateMode 1
    Abort
  ; Downgrading
...
; 5. Choose install directory page（已探测到旧路径就跳过）
!define MUI_PAGE_CUSTOMFUNCTION_PRE SkipDirectoryIfKnown
